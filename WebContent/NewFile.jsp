...
<frameset name="myFrame" cols="220,*" frameborder="no" border="0" framespacing="0">
    <frame src="left2.jsp" name="leftFrame" style="padding-left: 0px; padding-top: 0px;" frameborder="no" scrolling="no" noresize="noresize" id="leftFrame" title="leftFrame" />
    <frameset name="myFrame" rows="40,*" frameborder="no" border="0" framespacing="0">
      <frame src="navi2.jsp" name="navFrame" id="navFrame" scrolling="no" title="manFrame" />
      <frame src="help.jsp" name="mainAction" frameborder="no" id="manFrame" style="padding-left: 2px" title="manFrame" />
    </frameset>
</frameset>
</frameset>
<body></body>
